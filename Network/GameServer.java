...
public class GameServer implements Runnable
{
	...
	public void gamestart(GameCommand object) throws RemoteException {
		object.start(clients);
	}
	...
	public static void main(String[] args) throws IOException
	{
		...
		try {
			...
			Naming.rebind("rmi//localhost:1099/GameCommand", g);
		}catch(RemoteException re) {
	...
	public void run()
	{
		...
		try
		{
			...
			while ((inputLine = in.readLine()) != null)
			{
				...
				//if(inputLine.equalsIgnoreCase("-start")) gameServer.gamestart(g);
